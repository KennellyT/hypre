...
c
      ...
      parameter  (MAX_LOCAL_SIZE=4200000)
...
c        Set some parameters (See Reference Manual for more parameters) 
         call HYPRE_ParCSRBiCGSTABSetMaxIter(solver, 1000, ierr)
         call HYPRE_ParCSRBiCGSTABSetTol(solver, 1.0d-7, ierr)
         !call HYPRE_ParCSRGMRESSetTwoNorm(solver, 1, ierr)
         call HYPRE_ParCSRBiCGSTABSetPrintLev(solver, 2, ierr)
         call HYPRE_ParCSRBiCGSTABSetLogging(solver, 1, ierr)
...
c        Run info - needed logging turned on 
     ...
     1                                       ierr)
        call HYPRE_ParCSRBiCGSTABGetFinalRel(solver, final_res_norm,
     1                                       ierr)
